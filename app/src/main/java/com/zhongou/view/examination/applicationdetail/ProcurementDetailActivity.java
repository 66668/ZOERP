...
public class ProcurementDetailActivity extends BaseActivity {
    ...
    private List<ProcurementModel.ApprovalInfoLists> modelList;
    //动态添加view
    ...
    public void getDetailModel(final MyApplicationModel model) {
        ...
        Loading.run(this, new Runnable() {
            ...
            public void run() {
                try {
                    ProcurementModel model1 = UserHelper.applicationDetailPostProcurement(ProcurementDetailActivity.this,
