...
public class OutGoingDetailActivity extends BaseActivity {
    ...
    private void setShow(OutGoingModel model) {
        ...
        if (outGoingModel.getApprovalStatus().contains("1") || outGoingModel.getApprovalStatus().contains("2")) {
            //插入意见
    ...
    public void getDetailModel(final MyApplicationModel model) {
        ...
        Loading.run(this, new Runnable() {
            ...
            public void run() {
                try {
                    OutGoingModel model1 = UserHelper.applicationDetailPostOutGoing(OutGoingDetailActivity.this,
