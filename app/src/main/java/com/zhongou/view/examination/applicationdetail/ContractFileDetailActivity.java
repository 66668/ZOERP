...
public class ContractFileDetailActivity extends BaseActivity {
    //back
    ...
    private void setShow(ContractFileModel model) {
        ...
        if (contractFileModel.getApprovalStatus().contains("1") || contractFileModel.getApprovalStatus().contains("2")) {
            //插入意见
    ...
    public void getDetailModel(final MyApplicationModel model) {
        ...
        Loading.run(this, new Runnable() {
            ...
            public void run() {
                try {
                    ContractFileModel model1 = UserHelper.applicationDetailPostContractFile(ContractFileDetailActivity.this,
