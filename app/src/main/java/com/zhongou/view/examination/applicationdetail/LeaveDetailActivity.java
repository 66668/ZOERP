...
public class LeaveDetailActivity extends BaseActivity {
    ...
    private List<LeaveDetailActivity.ViewHolder> listViewHolder = new ArrayList<LeaveDetailActivity.ViewHolder>();
    ...
    public void getDetailModel(final MyApplicationModel model) {
        Loading.run(this, new Runnable() {
            ...
            public void run() {
                try {
                    LeaveModel model1 = (LeaveModel) UserHelper.applicationDetailPostLeave(LeaveDetailActivity.this,
    ...
    //初始化参数
    private LeaveDetailActivity.ViewHolder AddView(int marks) {
    ...
    private LeaveDetailActivity.ViewHolder getViewInstance(View childView) {
        LeaveDetailActivity.ViewHolder vh = new LeaveDetailActivity.ViewHolder();
