...
public class FinancialFeeDetailCopyActivity extends BaseActivity {
    //back
    ...
    public void getDetailModel(final MyCopyModel model) {
        Loading.run(this, new Runnable() {
            ...
            public void run() {
                try {
                    FinancialAllModel model1 = UserHelper.copyDetailPostFinancialAll(FinancialFeeDetailCopyActivity.this,
