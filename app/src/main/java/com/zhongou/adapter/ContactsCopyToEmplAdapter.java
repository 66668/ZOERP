 ...
 * 抄送 通讯录 适配
 */
public class ContactsCopyToEmplAdapter extends BaseAdapter implements SectionIndexer{

	private List<ContactsEmployeeModel> list = null;
	private Context mContext;
	private static HashMap<Integer,Boolean> isSelectedMap;//用来控制CheckBox的选中状况

	public ContactsCopyToEmplAdapter(Context mContext, List<ContactsEmployeeModel> list) {
	...
	public static void setIsSelectedMap(HashMap<Integer, Boolean> isSelected) {
		ContactsCopyToEmplAdapter.isSelectedMap = isSelected;
	}
}