...
public class ProcurementCopyModel implements Serializable {
    ...
    public List<ProcurementCopyModel.ApprovalInfoLists> ApprovalInfoLists;
    ...
    public List<ProcurementCopyModel.ApprovalInfoLists> getApprovalInfoLists() {
        return ApprovalInfoLists;
    }

    public void setApprovalInfoLists(List<ProcurementCopyModel.ApprovalInfoLists> ApprovalInfoLists) {
