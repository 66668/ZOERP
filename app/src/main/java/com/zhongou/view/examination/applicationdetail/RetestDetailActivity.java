...
public class RetestDetailActivity extends BaseActivity {
    //back
    ...
    public void getDetailModel(final MyApplicationModel model) {
        ...
        Loading.run(this, new Runnable() {
            ...
            public void run() {
                try {
                    RetestModel model1 = UserHelper.applicationDetailPostRetest(RetestDetailActivity.this,
