 ...
 * 采购领用适配
 */
public class ProcueRecordListAdapter extends BaseAdapter {
    Context mContext;
    List<String> list;
    public ProcueRecordListAdapter(Context mContext, List<String> list){
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if(view==null){
            ...
            view = LayoutInflater.from(mContext).inflate(R.layout.item_procuerecord, null, false);
