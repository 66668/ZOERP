...
public class WorkOverTimeDetailApvlActivity extends BaseActivity {
    //back
    ...
    private WorkOverTimeApvlModel model;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_apps_examination_workovertime_d2);
        tv_right.setText("");
    ...
    protected void handleMessage(Message msg) {
        ...
        switch (msg.what) {
            case POST_SUCCESS:
                model = (WorkOverTimeApvlModel) msg.obj;
                setShow(model);
                break;
            case POST_FAILED:
