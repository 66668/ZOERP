...
public class BorrowCopyModel implements Serializable {
    ...
    public List<BorrowCopyModel.ApprovalInfoLists> getApprovalInfoLists() {
        return ApprovalInfoLists;
    }

    public void setApprovalInfoLists(List<BorrowCopyModel.ApprovalInfoLists> approvalInfoLists) {
