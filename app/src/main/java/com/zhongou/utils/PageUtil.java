...
public class PageUtil {
    //长显示
    public static void DisplayToastLong(String loginactivityCompanyid) {
        Toast toast = Toast.makeText(MyApplication.getInstance(), loginactivityCompanyid, Toast.LENGTH_LONG);
        toast.show();
    }
