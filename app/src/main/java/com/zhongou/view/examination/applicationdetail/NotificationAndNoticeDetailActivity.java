...
public class NotificationAndNoticeDetailActivity extends BaseActivity {
    //back
    ...
    public void getDetailModel(final MyApplicationModel model) {
        ...
        Loading.run(this, new Runnable() {
            ...
            public void run() {
                try {
                    NotificationAndNoticeModel model1 = UserHelper.applicationDetailPostNotificationAndNotice(NotificationAndNoticeDetailActivity.this,
