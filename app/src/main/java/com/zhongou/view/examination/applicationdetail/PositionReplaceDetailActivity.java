...
public class PositionReplaceDetailActivity extends BaseActivity {
    //back
    ...
    public void getDetailModel(final MyApplicationModel model) {
        ...
        Loading.run(this, new Runnable() {
            ...
            public void run() {
                try {
                    PositionReplaceModel model1 = UserHelper.applicationDetailPostPositionReplace(PositionReplaceDetailActivity.this,
