...
public class NotificationAndNoticeDetailApvlActivity extends BaseActivity {
    //back
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_apps_examination_notificationandnotice_d2);
    ...
    protected void handleMessage(Message msg) {
        ...
        switch (msg.what) {
            case POST_SUCCESS:
                model = (NotificationAndNoticeApvlModel) msg.obj;
                setShow(model);
                break;
            case POST_FAILED:
