...
public class PositionReplaceCopyModel implements Serializable {
    ...
    public List<PositionReplaceCopyModel.ApprovalInfoLists> getApprovalInfoLists() {
        return ApprovalInfoLists;
    }

    public void setApprovalInfoLists(List<PositionReplaceCopyModel.ApprovalInfoLists> ApprovalInfoLists) {
