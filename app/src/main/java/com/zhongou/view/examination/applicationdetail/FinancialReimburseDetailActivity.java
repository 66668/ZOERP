...
public class FinancialReimburseDetailActivity extends BaseActivity {
    //back
    ...
    public void getDetailModel(final MyApplicationModel model) {
        Loading.run(this, new Runnable() {
            ...
            public void run() {
                try {
                    LoanReimbursementModel model1 = UserHelper.applicationDetailPostLoan(FinancialReimburseDetailActivity.this,
