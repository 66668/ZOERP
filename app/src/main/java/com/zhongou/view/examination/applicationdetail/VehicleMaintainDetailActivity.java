...
public class VehicleMaintainDetailActivity extends BaseActivity {
    //back
    ...
    public void getDetailModel(final MyApplicationModel model) {
        Loading.run(this, new Runnable() {
            ...
            public void run() {
                try {
                    VehicleMaintainModel model1 = UserHelper.applicationDetailPostVehicleMaintenance(VehicleMaintainDetailActivity.this,
