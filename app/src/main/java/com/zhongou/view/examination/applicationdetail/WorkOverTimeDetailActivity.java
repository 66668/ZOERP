...
public class WorkOverTimeDetailActivity extends BaseActivity {
    ...
    public void getDetailModel(final MyApplicationModel model) {
        Loading.run(this, new Runnable() {
            ...
            public void run() {
                try {
                    WorkOverTimeModel model1 = UserHelper.applicationDetailPostWorkOverTime(WorkOverTimeDetailActivity.this,
