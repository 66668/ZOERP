...
import com.zhongou.view.examination.applicationdetail.LoanReimbursementDetailActivity;
...
public class ZOApplicationActivity extends BaseActivity implements RefreshListView.IReflashListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_apps_examination_myapplication);
        tv_right.setText("");
        ...
        myListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Toast.makeText(ZOApplicationActivity.this, "position=" + position, Toast.LENGTH_SHORT).show();
    ...
    public void getNewData() {
        ...
        Loading.run(ZOApplicationActivity.this, new Runnable() {
            @Override
            public void run() {
                ifLoading = true;//
    ...
    public void onRefresh() {
        Loading.noDialogRun(ZOApplicationActivity.this, new Runnable() {
    ...
    private void myApplicationDetail(String type, MyApplicationModel model) {
        ...
        switch (type) {
            ...
            case "车辆维保"://09
                ...
                break;
            case "借款报销申请"://10
                intent.setClass(this, LoanReimbursementDetailActivity.class);
                startActivity(intent);
                break;
            case "调动申请"://11
