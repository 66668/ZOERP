...
public class FinancialLoanDetailAplActivity extends BaseActivity {
    //back
    ...
    public void getData(final MyApplicationModel model) {
        Loading.run(this, new Runnable() {
            ...
            public void run() {
                try {
                    FinancialAllModel model1 = UserHelper.applicationDetailPostLoan(FinancialLoanDetailAplActivity.this,
